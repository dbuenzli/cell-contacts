...
val contacts :
  ...
  Cell.Contact.info Cell.Group.data option Note.signal

val contact_stats :
  Cell.Contact.info Cell.Group.data option Note.signal -> El.t
...
val download_distances_csv :
  obs:Observation.t ->
  t:Cell.Group.t ->
  contacts:Cell.Contact.info Cell.Group.data ->
  Brr.El.t
